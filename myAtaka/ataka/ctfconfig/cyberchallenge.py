...
STATIC_EXCLUSIONS = {
    "10.60.10.1", #TODO: Set our ip here
}
...
FLAG_BATCHSIZE = 50 # Maximum list length for submit_flags()

FLAG_RATELIMIT = 2 # Minimum wait in seconds between each call of submit_flags()

START_TIME = 1778223600 # First time -> When the CTF starts, set to 1 minute in the future for testing

#START_TIME = 1778241600 # Second time 
### END EXPORTED CONFIG

TEAM_TOKEN = "0b7abcf3cdaa23307900c7dd2c04f41c"
